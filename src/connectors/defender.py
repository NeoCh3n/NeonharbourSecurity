"""Read-only Microsoft Defender adapter via Graph Security API."""
...
class DefenderClient:
    def __init__(
        ...
        *,
        ...
        self.client_id = client_id or os.getenv("DEFENDER_CLIENT_ID")
        self.client_secret = client_secret or os.getenv("DEFENDER_CLIENT_SECRET")
    ...
    def list_alerts(self, limit: int = 20) -> List[Dict[str, Any]]:
        ...
        if not all([self.tenant_id, self.client_id, self.client_secret]):
            return self._load_fixture("defender_alerts.json")[:limit]
        raise NotImplementedError("Implement Graph OAuth 2.0 client credentials and /security/alerts query.")
